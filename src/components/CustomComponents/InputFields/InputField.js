...
const InputField = ({ label, type, value, onChange, options, isSelect = false, isPhoneNumber = false, isPassword = false, isTextarea = false, name, error, onInputChange, disabled, onKeyPress, isChecking }) => {
